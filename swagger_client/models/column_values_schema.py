...
class ColumnValuesSchema(object):
    ...
    def __init__(self):  # noqa: E501
        """ColumnValuesSchema - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(ColumnValuesSchema, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ColumnValuesSchema):
            return False
