...
class PartnerLoaMetadata(object):
    ...
    """
    swagger_types = {
        'attachment_url': 'WrittenLoaUrlSchema'
    }
    ...
    def __init__(self, attachment_url=None):  # noqa: E501
        """PartnerLoaMetadata - a model defined in Swagger"""  # noqa: E501
    ...
    def attachment_url(self):
        """Gets the attachment_url of this PartnerLoaMetadata.  # noqa: E501


        :return: The attachment_url of this PartnerLoaMetadata.  # noqa: E501
        :rtype: WrittenLoaUrlSchema
        """
        return self._attachment_url

    @attachment_url.setter
    def attachment_url(self, attachment_url):
        """Sets the attachment_url of this PartnerLoaMetadata.


        :param attachment_url: The attachment_url of this PartnerLoaMetadata.  # noqa: E501
        :type: WrittenLoaUrlSchema
        """
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(PartnerLoaMetadata, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, PartnerLoaMetadata):
            return False
